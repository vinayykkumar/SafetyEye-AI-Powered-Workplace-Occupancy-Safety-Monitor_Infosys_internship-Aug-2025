...
# File to store mapping of hash → original filename
mapping_file = os.path.join(output_lbl_dir, "filename_mapping.txt")
mapping_f = open(mapping_file, "w")
...
for img_path in images:
    ...
    # Generate a short unique name (MD5 hash)
    ...
    # Save augmented image & label with short name
